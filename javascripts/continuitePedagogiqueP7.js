    ...
    function afficheNewPage(titre, callback) {
        ...
        switch (titre) {
            ...
            case 'III - Sens de variation d\'une fonction et signe du nombre dérivé':
                ...
                newContent += '<li>Exercice 73 p. 116. Cet exercice est à me rendre <b>pour le vendredi 27 mars</b> (sur traitement de texte - LibreOffice - ou sur feuille en m\'envoyant une photo.</li>'
                //newContent += '<li>Voici le <a href="pdf/ex73p116.pdf" target="_blank">corrigé de l\'exercice 73 p. 116</a>.</li>'
                newContent += '<li>Dernier exercice du chapitre sous forme d\'un devoir à rendre : exercice 97 p. 121 + <a href="pdf/Courbe DM01.pdf" target="_blank">exercice sur les nombres dérivés</a> pour <b>mardi 31 mars (envoi pas mail ou moodle)</b></li></ul></p>'
                break
            default:
                //accueil
